...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2024 at 07:23 AM
...
(1, 'Hamzar Dokan', 'Online Shopping Project for Mobiles, Clothes, Electronics and many more....', '1734590929hdsitelogo.png', 'About Us\r\nWe are committed to bringing you high-quality products that you can trust. Our mission is to provide a seamless shopping experience with exceptional value and customer service. Shop with confidence and discover the difference in quality and care', 'Copyright 2024', 'Tk.', '+8801690250849', 'mail@hamzaa.top', '#1204,West Jurain,Dhaka,Bangladesh.');
...
(47, '9,', '1,', '359', 2, '2024-12-21', '', 0, 0),
(48, '9,', '1,', '359', 2, '2024-12-21', '', 0, 0);
...
(14, '6763bcaa7fd1f', 10, 29, 0, 'MEN&#039;S CLASSIC PANJABI', '799', '&lt;p&gt;&lt;b&gt;The Men&#039;s Classic Panjabi &lt;/b&gt;is a timeless traditional attire that perfectly blends cultural heritage with modern elegance. Designed for comfort and style, this Panjabi is crafted from high-quality, breathable fabric, ensuring a perfect fit for all occasions.&lt;/p&gt;&lt;p&gt;Featuring a straight-cut design, full sleeves, and intricate embroidery or minimalistic detailing, it adds a touch of sophistication to your look. The versatile style makes it suitable for festive celebrations, religious gatherings, or casual wear. Pair it with pajama, churidar, or jeans to create a statement outfit that exudes charm and tradition.&lt;/p&gt;&lt;p&gt;Available in a range of colors and sizes, the Men&#039;s Classic Panjabi is the ideal choice for those who value tradition and style.&lt;/p&gt;', '1734589610panjabi1.jpg', 10, NULL, 2, 1),
(15, '6763bf5c76012', 10, 30, 0, 'MENS TRACKER JACKET', '2250', '&lt;p&gt;&lt;b&gt;The Men&#039;s Tracker Jacket&lt;/b&gt; is the ultimate fusion of functionality and style, designed to keep you comfortable and trendy in any season. Made with high-quality, durable materials, this jacket offers lightweight warmth and wind resistance, making it perfect for outdoor adventures or casual everyday wear.&lt;/p&gt;&lt;p&gt;Featuring a sleek, modern design, the jacket includes a zip-up front, adjustable cuffs, and multiple secure pockets for practicality. The versatile fit ensures it layers easily over any outfit, whether you&#039;re hitting the gym, running errands, or exploring the outdoors.&lt;/p&gt;&lt;p&gt;Available in a variety of colors and sizes, the Men&#039;s Tracker Jacket is your go-to outerwear for an active, stylish lifestyle.&lt;/p&gt;', '1734590300menjacket.jpg', 9, NULL, 0, 1);
